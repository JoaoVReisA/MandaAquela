  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Modular.to.push(MaterialPageRoute<void>(
        builder: (_) => MusiciansPage(oportunity: oportunity),
      )),
      child: Container(
            ...
            Column(
              ...
              children: [
                ...
                SvgAndText(
                  ...
                  text: Text(
                    oportunity.musicianInterestedIds.length.toString(),
                    style: TextStyles.poppins14px700w
                        .copyWith(color: AppColors.gray),
                  ),
                ),
